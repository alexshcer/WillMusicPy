...
namespace eval ttk::theme::WillMusicTheme {

    variable version 1.3
    package provide ttk::theme::WillMusicTheme $version
    variable colors
    array set colors {
        -fg             "#ffffff"
        -bg             "#333333"
    ...
    LoadImages [file join [file dirname [info script]] WillMusicTheme]

    # Settings
    ttk::style theme create WillMusicTheme -parent default -settings {
        ttk::style configure . \
